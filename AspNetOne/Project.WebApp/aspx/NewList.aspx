<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewList.aspx.cs" Inherits="Project.WebApp.aspx.NewList" %>
        ...
        <div id="main_column">
            <div id="sidebar_column">
                ...
                <a href="../Contact/Contact.html" class="contct">
                    <img src="WebDemos/images/img_contact_sidebarcolumn.png" width="160" height="52" alt="联系我们" /></a><!-- #EndLibraryItem -->
            </div>
            <div id="content_column">
                <div class="position"><a class="graylink" href="../index.html">首页</a>&nbsp;&lt;&nbsp;<span class="color0range">新闻中心</span></div>
                <div class="cont">
                    <ul class="list_news">
                        <%--<li><span>2010-08-18</span><a href="Shownews.html" target="_blank">上半年全区地税收入再创历史新高</a></li>--%>
                        <%=StrHtml %>
                    </ul>
                    <div class="pages">
                        ...
                        <div class="page_nav">
                            <a href="NewList.aspx?pageIndex=1">首页</a>
                            <%=Project.Common.PageBar.GetPageBar(PageIndex,PageCount)%>
                            <a href="NewList.aspx?pageIndex=<%=PageCount %>">尾页</a>
                        </div>
